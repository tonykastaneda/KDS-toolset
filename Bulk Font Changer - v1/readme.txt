Use the "LocalFontInfo.jsx" by clicking on a font and then run script 

Capture the information and in a GPT model just ask it this prompt
...
{Put the font info of the original font}
