...
# Create the "soro_mockup_export" subfolder in the root of the PROJECT directory
output_folder="${PROJECT_DIR}soro_mockup_export/"
mkdir -p "$output_folder"

file_name="${output_folder}soro_logo_data.txt"  # Use absolute path for logo_data.txt
