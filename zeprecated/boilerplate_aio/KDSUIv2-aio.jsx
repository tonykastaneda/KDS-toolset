...
// Create main window
var win = new Window("dialog", "KDSUI v2 BETA AIO");




// Add a static text block at the top
var statictext1 = win.add("group", undefined , {name: "statictext1"}); 
statictext1.orientation = "column"; 
statictext1.alignChildren = ["center","center"]; 
statictext1.spacing = 0; 

statictext1.add("statictext", undefined, "\u2139 GPU Rendering must be off"); 
statictext1.add("statictext", undefined, "llustrator > Performance > GPU Performance \u2610");
