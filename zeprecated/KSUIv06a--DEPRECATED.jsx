...
// Create dialog
var dialog = new Window("dialog", "KSUI v0.6a");
...
startButton.onClick = function() {
    ...
    runScript(fratNames, fratOutputPath, heightInput.text, actionInput.text, widthCheckbox.value ? null : widthInput.text, skipActionCheckbox.value);
    resetState();
    runScript(soroNames, soroOutputPath, heightInput.text, actionInput.text, widthCheckbox.value ? null : widthInput.text, skipActionCheckbox.value);
    dialog.close();
}
...
function runScript(names, output, height, action, width, skipAction) {
