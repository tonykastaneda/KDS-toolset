...
startButton.onClick = function() {
    try {
        ...
        if (originalFileLocation) { // If a .ai file was found
            ...
            runScript(names1, output1, height, action, width, originalFileLocation);
            runScript(names2, output2, height, action, width, originalFileLocation);
        }
    } catch (error) {
        alert("Error: " + error);
    }
...
function runScript(names, outputLocation, height, action, width, originalFileLocation) {
    for (var i = 0; i < names.length; i++) {
        ...
        // Store the original width and height of the text frame
        var originalWidth = textFrame.width;
        var originalHeight = textFrame.height;
        ...
        // Reset the position of the text frame back to its original position
...
function runScript(names, outputLocation, height, action, width, originalFileLocation) {
    for (var i = 0; i < names.length; i++) {
        ...
        var originalHeight = textFrame.height; // Store the original height
