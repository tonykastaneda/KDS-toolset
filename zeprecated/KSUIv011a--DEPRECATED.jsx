...
var fratNames = importNames(fratNamesInput.text);
var soroNames = importNames(soroNamesInput.text);
...
// Create dialog
var dialog = new Window("dialog", "KSUI v0.11a");
...
var fratNamesGroup = dialog.add("group");
...
var soroNamesGroup = dialog.add("group");
