...
var logFile = new File(originalFile.path + "/log.txt"); // Log file
...
var scriptFile1 = new File(originalFile.path + "/frat_export/logo-extractor.jsx");
if (scriptFile1.exists) {
    $.evalFile(scriptFile1);
} else {
    alert("Error: 'logo-extractor.jsx' does not exist in the '/frat_export' directory.");
}

var scriptFile2 = new File(originalFile.path + "/soro_export/logo-extractor.jsx");
if (scriptFile2.exists) {
    $.evalFile(scriptFile2);
} else {
    alert("Error: 'logo-extractor.jsx' does not exist in the '/soro_export' directory.");
}