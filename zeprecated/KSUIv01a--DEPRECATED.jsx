...
// Create dialog
var dialog = new Window("dialog", "KSUI v0.1a");
...
var widthCheckbox = widthGroup.add("checkbox", undefined, "Keep text frame width");
widthCheckbox.value = true;
widthGroup.add("statictext", undefined, "Or define width:");
...
heightGroup.add("statictext", undefined, "Text Frame Height:");
...
startButton.onClick = function() {
    runScript(fratNames, fratOutputInput.text, heightInput.text, actionInput.text, widthCheckbox.value ? null : widthInput.text);
    resetState();
    runScript(soroNames, soroOutputInput.text, heightInput.text, actionInput.text, widthCheckbox.value ? null : widthInput.text);
    dialog.close();
}
