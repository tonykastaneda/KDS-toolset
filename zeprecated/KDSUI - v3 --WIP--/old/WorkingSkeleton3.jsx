...
var targetSublayerName = "name"; // Replace with your sublayer name

// Function to find a sublayer by name
function findSublayer(layers, name) {
    for (var i = 0; i < layers.length; i++) {
        var layer = layers[i];
        if (layer.layers) {
            var found = findSublayer(layer.layers, name);
