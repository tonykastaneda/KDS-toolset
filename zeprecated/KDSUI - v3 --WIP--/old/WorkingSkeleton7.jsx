...
function processNames(names, exportFolder) {
    for (var k = 0; k < names.length; k++) {
        ...
        // Store the baseline shift and font size of the first and last characters separately
        ...
        // Apply the baseline shift and font size of the first character to the first character of the new text
        ...
        // Apply the baseline shift and font size of the last character to the last character of the new text
