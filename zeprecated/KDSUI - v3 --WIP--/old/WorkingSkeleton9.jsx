...
function processNames(names, exportFolder) {
    for (var k = 0; k < names.length; k++) {
        ...
        // Reset all characters to default attributes
        for (var i = 0; i < textFrame.textRange.characters.length; i++) {
            ...
            textFrame.textRange.characters[i].characterAttributes.size = textFrame.textRange.characters[0].characterAttributes.size;
        }
